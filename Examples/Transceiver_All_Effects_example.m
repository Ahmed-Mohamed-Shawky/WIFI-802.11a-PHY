...
LENGTH = 1000;      % 1-4095                % Transmitter Default Length: 100
...
Receiver.PacketDetectionMode = 1; % Enable Packet Detection Block
Receiver.EqualizerMode = 1; % Enable Channel Estimation & Equlaization Block
Receiver.CFO_Mode = 1;  % Enable Carrier Offset Estimation & Compensation Block
...
Effects.add_CFO(100) %% Add 100% of Carrier offset
Effects.add_STO(randi([300,1000])) %% Number of added samples befor the waveform
Effects.add_Noise(20); %% SNR = 20
Effects.add_Channel("Rayleigh") % "Rayleigh" or "Racian"
